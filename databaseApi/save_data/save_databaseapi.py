...
class pos_setting:
    ...
    def addproduct(self, product_name1, product_brand1, product_vat1, product_code1, product_price1,
        ...
        pos_setting.__addproduct__(self, product_name1, product_brand1, product_vat1, product_code1, product_price1,
                                   product_quantity1, percentage_vat1)

    def __addproduct__(self, product_name1, product_brand1, product_vat1, product_code1, product_price1,
                       product_quantity1, percentage_vat1):
    ...
    def addusers(self, first_name1, last_name1, role1, username1, password1, blood_group1,
        ...
        pos_setting.__addusers__(self, first_name1, last_name1, role1, username1, password1, blood_group1,
                                 salary1, national_id1)

    def __addusers__(self, first_name1, last_name1, role1, username1, password1,
                     salary1, national_id1, blood_group1):
        ...
        with open(pos_setting.add_users, "r") as f:
            ...
            if username in usernames and nationalId in nat_id:
                ...
                mess_username.warning(None, "Error in username",
                                      "Username already taken kindly change your username!!!!")
            else:
                if role in roles:
                    data = {
                        "Firstname": firstName,
                    ...
                    with open(pos_setting.add_users, 'w') as f:
                        ...
                        messd = QMessageBox()
                        messd.setFont(pos_setting.font1)
                        messd.information(None, "saving", "User has been saved successfully")
    ...
    def roles(self, role1):
        pos_setting.__roles__(self, role1)

    def __roles__(self, role1):
        # Check if data file exists, otherwise create an empty file with an empty JSON array
